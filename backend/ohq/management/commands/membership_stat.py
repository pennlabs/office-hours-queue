...
from ohq.models import Membership, User, Question, Semester #MembershipStatistic
from ohq.statistics import calculate_student_avg_time_stats, calculate_instructor_avg_time_stats
