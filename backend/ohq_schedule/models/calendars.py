...
from ohq_schedule.settings import USE_FULLCALENDAR
from ohq_schedule.utils import EventListManager
...
class CalendarRelation(models.Model):
    ...
    content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, related_name="ohq_calendarrelation_set")
