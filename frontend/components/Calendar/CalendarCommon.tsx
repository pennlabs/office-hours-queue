...
import { SlidingBookingForm } from "./StudentCalendar/SlidingBookingForm";
...
export const EventInfoModal = (props: {
    ...
    const handleBack = () => {
        setIsTransitioning(true);
        setSelectedSlot(null); // Match transition duration
    };
    ...
    const handleConfirm = () => {
        ...
        setIsTransitioning(true);
        setTimeout(() => setSelectedSlot(null), 300); // Match transition duration
    };
                        ...
                        >
                            ...
                            >
                                <BookingSlots
                                    ...
                                    onSlotSelect={(slot) =>
                                        handleSlotSelect(slot.start, slot.end)
                                    }
                                />
                            </div>
                            <div
                                style={{
                                    ...
                                    transform: selectedSlot
                                        ? "translateX(0)"
                                        : "translateX(100%)",
                                    zIndex: selectedSlot ? 1 : 0,
                                    willChange: "transform",
                                }}
                            >
                                {(selectedSlot || isTransitioning) && (
                                    <SlidingBookingForm
                                        slot={
                                            selectedSlot || {
                                                start: new Date(),
