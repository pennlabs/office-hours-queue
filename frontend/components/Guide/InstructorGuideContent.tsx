...
export const CreateCourse = ({ ref }) => (
    <div ref={ref}>
        <Segment basic>
            ...
            <Divider />
            <p>
                Once you log in to OHS, click &apos;Dashboard&apos; on the left,
            ...
            <p>
                OHS currently supports Zoom, BlueJeans, Google Meet, and Whereby
                meetings links. Please email us at contact@ohs.io to request
            ...
            <br />
            <p>
                And that&apos;s it! You&apos;ve created your course on OHS, and
                        ...
                        <List.Item>
                            ...
                            <List.List>
                                <List.Item>
                                    ...
                                    formats will not be able to log in to OHS.
                                    🚨
                                </List.Item>
                            </List.List>
                        </List.Item>
        ...
        <Segment basic>
            ...
            <List>
                <List.Item>
                    ...
                    &apos;Dashboard&apos; page, click &apos;Stacks&apos; on the
                    left. Then, click &apos;Create&apos;. Choose a name and
                    description for your stack.
                    <List.List>
                        <List.Item>
                            🤔 Not sure what to name your stack?
                        </List.Item>
                        <List.Item>
                            Here are stack names we&apos;ve seen from some
                            current courses:
                            <ul>
                                <li>Professor Office Hours</li>
                                <li>TA Office Hours</li>
                                <li>Quick Questions Stack</li>
            ...
            <p>
                You can change the name and description of the stack at any
                time.
            </p>
            <p>
                Once you&apos;ve created the stack, you are ready to open the
                stack and start holding office hours! 🙌
            </p>
        </Segment>
    </div>
);
...
export const HoldOfficeHours = ({ ref }) => (
    <div ref={ref}>
        <Segment basic>
            ...
            <h5>Opening the Stack</h5>
            <Divider />
            <p>
                To start your office hours, open the stack to students by
                clicking &apos;Open&apos;.
            </p>
            <CenteredImage
            ...
            />
            <p style={{ color: "grey", textAlign: "center" }}>
                After opening both stacks.
            </p>
            <p>Now students will be able to join the stack!🖥️</p>
            <br />
            <h5>Answering Questions</h5>
            <Divider />
            <p>
                When students join the stack, you will see their names appear
            ...
            />
            <br />
            <h5>Putting Students Back in the Stack</h5>
            <Divider />
            <p>
            ...
            <br />
            <h5>Closing the Stack</h5>
            <Divider />
            <p>
                To close the stack, click &apos;Close&apos;. Closing the stack
                will prevent students from joining the stack, but it will not
                remove students already in the stack.
            </p>
            <p>
                To remove all of the students currently on the stack, click
                &apos;Clear&apos; after closing the stack.
            </p>
...
export const Analytics = ({ ref }) => (
    <div ref={ref}>
        <Segment basic>
            ...
            <Divider />
            <p>
                As an instructor, you can use OHS&apos;s analytics to learn what
            ...
            <p>
                ...
                OHS&apos;s analytics page. Please fill out{" "}
...
export const Settings = ({ ref }) => (
    <div ref={ref}>
        <Segment basic>
            ...
            <Divider />
            <p>
                To change the settings of a stack, navigate to the stack and
            ...
            <p>
                To change your account settings, go to the OHS landing page and
