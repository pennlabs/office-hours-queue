    ...
    <div ref={ref}>
        <Segment basic>
            ...
            <List bulleted>
                ...
                <List.Item>
                    To edit your question, you can click the green "Edit" button
                    and update your question. You won't lose your place in line!
                </List.Item>
                <List.Item>
                    To delete your question, click on the red "Withdraw" button.
                    You'll be automatically removed from the queue.
                </List.Item>
                <CenteredImage
